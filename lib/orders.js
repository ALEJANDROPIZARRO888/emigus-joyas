...
// La columna F ("Total (CLP)") tiene formato moneda ($#,##0) en el Sheet, y
// readRange (sin valueRenderOption) trae el VALOR FORMATEADO, no el número
// crudo — o sea "$19.500" en vez de 19500. Number("$19.500") da NaN, así
// que el total quedaba mostrándose como $0 en Seguimiento y en el panel
// admin. Se limpia todo lo que no sea dígito antes de convertir (los
// totales son siempre pesos enteros, sin decimales).
